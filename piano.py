...
introduce1 = play.new_text(words = 'Фортепиано для удовольствия!', color = 'white', x = 0, y = 200)
introduce2 = play.new_text(words = 'Создайте свою мелодию, нажимая клавиши', color = 'white', x = 0, y = 150)

key_play_melody = play.new_box(color = 'light green', border_color = 'black', border_width = 1, x = -100, y = -170, width = 160, height = 50)
kpm = play.new_text(words = 'Играть мелодию', x = -100, y = -170, font_size = 20)
key_clear_melody = play.new_box(color = 'light yellow', border_color = 'black', border_width = 1, x = 100, y = -170, width = 160, height = 50)
kcm = play.new_text(words = 'Удалить мелодию', x = 100, y = -170, font_size = 20)
...
for i in range(8):
    ...
    sound = pygame.mixer.Sound(str(1+1)+'.ogg')
    keys.append(key)
    sounds.append(sound)
melody = []
